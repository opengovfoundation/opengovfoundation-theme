 ...
 * @uses opengovfoundation_header_style() to style front-end.
 * @uses opengovfoundation_admin_header_style() to style wp-admin form.
 * @uses opengovfoundation_admin_header_image() to add custom markup to wp-admin form.
...
function opengovfoundation_custom_header_setup() {
	$args = array(
		...
		'wp-head-callback'       => 'opengovfoundation_header_style',
		'admin-head-callback'    => 'opengovfoundation_admin_header_style',
		'admin-preview-callback' => 'opengovfoundation_admin_header_image',
	);
 ...
 * @since Twenty Thirteen 1.0
 */
function opengovfoundation_custom_header_fonts() {
...
add_action( 'admin_print_styles-appearance_page_custom-header', 'opengovfoundation_custom_header_fonts' );
 ...
 * @since Twenty Thirteen 1.0
 */
function opengovfoundation_header_style() {
	...
	?>
	<style type="text/css" id="opengovfoundation-header-css">
	<?php
	...
	?>
		...
		.home .site-header {
			background-image: url(<?php print str_replace(array('cropped-', '_header'), array('', '_hero'), $header_image); ?>) no-repeat scroll top;
		}
	<?php
		endif;
 ...
 * @since Twenty Thirteen 1.0
 */
function opengovfoundation_admin_header_style() {
	$header_image = get_header_image();
?>
	<style type="text/css" id="opengovfoundation-admin-header-css">
 ...
 * @since Twenty Thirteen 1.0
 */
function opengovfoundation_admin_header_image() {
